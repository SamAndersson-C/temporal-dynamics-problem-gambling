...
SELECT 
    ...
    m.date
FROM 
    customer_analysis_se.bets_data_excl_90d b
INNER JOIN 
...
-- Aggregate betting features over 90 days, including quantiles and averages for various betting metrics

CREATE TABLE customer_analysis_se.combined_bets_features_aggregated_90d AS
WITH quantiles AS (
    SELECT
        customer_id,
        label_date,
