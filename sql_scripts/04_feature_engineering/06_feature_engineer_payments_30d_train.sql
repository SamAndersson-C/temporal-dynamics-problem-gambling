...
-- 30day truncated
-- Create a view to aggregate payment features, excluding data beyond the assessment date
...
FROM 
    customer_analysis_se.payments_data_excl_30d p
INNER JOIN 
...
CREATE TABLE customer_analysis_se.combined_payments_features_aggregated_30d AS
